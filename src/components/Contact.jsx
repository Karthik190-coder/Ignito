...
export default function Contact() {
  return (
    <section id="contact" className="w-full py-24 px-6 bg-black relative z-10 border-t border-white/5 flex flex-col items-center">
      <div className="max-w-3xl w-full">
        ...
        <form 
          className="bg-white/5 border border-white/10 rounded-2xl p-8 md:p-12 backdrop-blur-md flex flex-col gap-6"
          onSubmit={(e) => e.preventDefault()} // Prevents page reload on submit for now
        >
          {/* Name & ID Row */}
          ...
          {/* Submit Button - with the signature Golden Energy hover! */}
